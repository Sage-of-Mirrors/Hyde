...
uint16_t JUTNameTab::HashName(std::string name) {
	uint16_t hash = 0;
...
void JUTNameTab::Serialize(bStream::CStream* stream) {
...
void JUTNameTab::Deserialize(bStream::CStream* stream) {
...
std::string JUTNameTab::GetName(uint16_t index) const {
...
void JUTNameTab::AddName(std::string name) {
