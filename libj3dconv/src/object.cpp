...
void CConverterObject::LoadBuffers(tinygltf::Model* model) {
...
bool CConverterObject::Load(tinygltf::Model* model) {
    LoadBuffers(model);
...
bool CConverterObject::WriteBMD(bStream::CStream& stream) {
    // Write header
