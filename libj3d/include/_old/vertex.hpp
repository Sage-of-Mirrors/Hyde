...
struct SVertex {
    ...
    bool operator==(const SVertex& other) {
        return PositionIndex == other.PositionIndex &&
            bUseNBT == other.bUseNBT &&
            NormalIndex == other.NormalIndex &&
            ColorIndex[0] == other.ColorIndex[0] &&
            ColorIndex[1] == other.ColorIndex[1] &&
            TexCoordIndex[0] == other.TexCoordIndex[0] &&
            TexCoordIndex[1] == other.TexCoordIndex[1] &&
            TexCoordIndex[2] == other.TexCoordIndex[2] &&
            TexCoordIndex[3] == other.TexCoordIndex[3] &&
            TexCoordIndex[4] == other.TexCoordIndex[4] &&
            TexCoordIndex[5] == other.TexCoordIndex[5] &&
            TexCoordIndex[6] == other.TexCoordIndex[6] &&
            TexCoordIndex[7] == other.TexCoordIndex[7];
    }
